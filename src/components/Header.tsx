      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
        ...
        >
          <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-white shadow-sm overflow-hidden p-0.5 transition-transform group-hover:scale-105 duration-300">
            <img src="https://assets.perthborewater.com.au/BoreWaterLogo.webp" alt="Perth BoreWater Logo" width="40" height="40" className="w-full h-full object-contain" referrerPolicy="no-referrer" />
          </div>
          <div>
